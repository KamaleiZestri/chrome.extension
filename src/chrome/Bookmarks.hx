...
extern class Bookmarks {
	...
	static function get( id : String, ?callback : Array<BookmarkTreeNode>->Void) : Promise<Array<BookmarkTreeNode>>;
	static function getChildren( id : String, ?callback : Array<BookmarkTreeNode>->Void ) : Promise<Array<BookmarkTreeNode>>;
	static function getRecent( numberOfItems : Int, ?callback : Array<BookmarkTreeNode>->Void ) : Promise<Array<BookmarkTreeNode>>;
	static function getTree( ?callback : Array<BookmarkTreeNode>->Void ) : Promise<Array<BookmarkTreeNode>>;
	static function getSubTree( id : String, ?callback : Array<BookmarkTreeNode>->Void ) : Promise<Array<BookmarkTreeNode>>;
	static function search( query : String, ?callback : Array<BookmarkTreeNode>->Void ) : Promise<Array<BookmarkTreeNode>>;
	static function create( bookmark : Bookmark) : Promise<BookmarkTreeNode>;
	static function move( id : String, destination : BookmarkDestination, ?callback : BookmarkTreeNode->Void ) : Promise<BookmarkTreeNode>;
	static function update( id : String, changes : BookmarkChanges, ?callback : Array<BookmarkTreeNode>->Void ) : Promise<BookmarkTreeNode>;
	static function remove( id : String, ?callback : Void->Void ) : Promise<Void>;
	static function removeTree( id : String, ?callback : Void->Void ) : Promise<Void>;
